...
const handleDragSetup = (e) => {
  ...
  // draggedElem.addEventListener("pointerup", handlePointerCleanup);
  handleDragStart(e);
};
...
// const handlePointerCleanup = (e) => {
//   draggedElem.removeEventListener("pointerup", handlePointerCleanup);
// };

const handleDragCleanup = (e) => {
...
const handleDropRepop = async (e) => {
  const newtag = e.dataTransfer.getData("text/plain");
  handleDrop(e);
  const tagCategory = e.currentTarget.dataset.zone; // droptarget
  if (
